...
public static class ServiceCollectionExtensions
{
        ...
        IConfiguration configuration)
    {
        ...
        // Vector store factory — creates one isolated IVectorStore per (system, data source) pair.
        // The factory is selected by VectorStore:Provider; no code changes needed to switch.
