...
public record PastPerformanceResponse
{
    ...
    /// <summary>
    /// Responses from any external AI plugins that were invoked during this request.
    /// Empty when no plugins are configured or none were selected by the router.
    /// </summary>
    public IReadOnlyList<ExternalAiResponse> PluginResponses { get; init; } = [];
}
